...
const PALETTE: Record<PlanetClass, [[number, number, number], [number, number, number]]> = {
  iron:          [[0.34, 0.29, 0.25], [0.19, 0.16, 0.14]],
  rocky:         [[0.42, 0.37, 0.32], [0.24, 0.20, 0.17]],
  desert:        [[0.72, 0.50, 0.30], [0.46, 0.28, 0.16]],
  ocean:         [[0.06, 0.20, 0.42], [0.10, 0.34, 0.52]],
  terrestrial:   [[0.13, 0.34, 0.17], [0.05, 0.16, 0.40]],
  lava:          [[0.34, 0.10, 0.05], [1.60, 0.42, 0.06]],
  carbon:        [[0.13, 0.12, 0.13], [0.30, 0.26, 0.22]],
  tundra:        [[0.40, 0.42, 0.38], [0.70, 0.76, 0.82]],
  ice:           [[0.72, 0.80, 0.90], [0.50, 0.62, 0.78]],
  'super-earth': [[0.36, 0.31, 0.26], [0.20, 0.30, 0.42]],
  'mini-neptune':[[0.36, 0.52, 0.60], [0.24, 0.40, 0.52]],
  'ice-giant':   [[0.22, 0.44, 0.66], [0.36, 0.62, 0.78]],
  'gas-giant':   [[0.68, 0.56, 0.42], [0.44, 0.32, 0.24]],
  'hot-jupiter': [[0.42, 0.16, 0.12], [0.86, 0.34, 0.14]],
  puffy:         [[0.62, 0.48, 0.52], [0.42, 0.30, 0.36]],
};
...
function makePlanet(
  ...
  return {
    ...
    moons,
    rings,
    color: biosphere > 0.25 ? [0.10, 0.30, 0.14] : c1,
    color2: c2,
